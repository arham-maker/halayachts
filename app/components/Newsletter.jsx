...
const Newsletter = ({
  ...
  recipientEmail = "arhum@crosswayconsulting.com",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(`Sending email to ${recipientEmail}:`, email);
        ...
        >
          ...
          >
            <motion.div className="flex flex-col gap-3" variants={itemVariants}>
              <h2 className="text-3xl md:text-6xl xl:text-[65px] font-light">
                {heading}
              </h2>
            ...
            <motion.div className="border-t border-[#D3D3D3]" variants={itemVariants}></motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="flex flex-col sm:flex-row items-stretch sm:gap-0 gap-5">
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full px-4 py-3 border border-white/50 
                                 sm:rounded-l-lg sm:rounded-r-none rounded
                                 focus:outline-none focus:border-transparent 
                                 text-[#77747B] placeholder-[#77747B] 
                  ...
                  <motion.button
                    ...
                    className="bg-text-primary text-white px-6 py-3 
                               sm:rounded-l-none sm:rounded-r-lg rounded
                               hover:bg-opacity-90 transition duration-300 
                               font-medium tracking-wide disabled:cursor-not-allowed min-w-[140px]"
                  >
                    {renderButtonContent()}
                  </motion.button>
                </div>
