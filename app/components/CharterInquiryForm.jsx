...
const STYLES = {
  ...
  buttonContainer: "p-6 border-t border-gray-200 bg-white sticky bottom-0 flex gap-4 sm:flex-row flex-col",
  button: "flex-1 px-6 sm:py-3 py-3 text-base font-medium tracking-wider rounded-lg transition-all duration-300",
